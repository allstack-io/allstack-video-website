...
export class Dashboard1Component implements OnInit {
  ...
  constructor(private amplifyService: AmplifyService) {
    /*this.amplifyService
      ...
      .then(user => {
        this.userid = user.storage['userid'];
      });*/
  ...
  ngOnInit() {
    ...
    /*const SubscribeToAdduserProfile = `subscription SubscribeToAdduserProfile($userid: String!) {
      addUserProfile(userid: $userid) {
        username
        email
        firstname
        lastname
    ...
    const observable = this.amplifyService
      .api()
      .graphql(graphqlOperation(SubscribeToAdduserProfile, {userid: 'us-east-1:0a759a33-5a6d-49c9-b2c0-988fac0f6ddc'})) as Observable<object>;
